...
export default class Paddle {
  ...
  moveDetect() {
    ...
    if (this.keyState[this.up] == this.keyState[this.down]) {
      // this line is XNOR, ie. reset accel when both/neither key is pressed
      this.currentSpeed = CONFIG.paddleVel;
    }
  ...
  coordinates(x, y, width, height) {
    // used for mapping collisions with ball
    let leftX = x;
    let rightX = x + width;
    let topY = y;
